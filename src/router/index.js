        ...
        children: [
            {
                path: '/analysis',
                name: 'analysis',
                component: () => import('@/views/new/Analysis.vue')
            },
            {
                path: '/tickets',
                name: 'tickets',
                component: () => import('@/views/new/Tickets.vue')
            },
            {
                path: '/game/results',
                name: 'game-results',
                component: () => import('@/views/new/GameResults.vue')
            },
            {
                path: '/report/cashier-report',
                name: 'cashier-report',
                component: () => import('@/views/new/CashierReport.vue')
            },
            {
                path: '/report/shop-report',
                name: 'shop-report',
                component: () => import('@/views/new/ShopReport.vue')
            },
            {
                path: '/report/admin-report',
                name: 'admin-report',
                component: () => import('@/views/new/AdminReport.vue')
            },
            {
                path: '/report/region-report',
                name: 'region-report',
                component: () => import('@/views/new/RegionReport.vue')
            },
            {
                path: '/report/masterAgent-report',
                name: 'masterAgent-report',
                component: () => import('@/views/new/MasterAgentReport.vue')
            },
            {
                path: '/user-accounts/cashier',
                name: 'cashier',
                component: () => import('@/views/new/Cashiers.vue')
            },
            {
                path: '/user-accounts/shops',
                name: 'shops',
                component: () => import('@/views/new/Shops.vue')
            },
            {
                path: '/user-accounts/Admins',
                name: 'admins',
                component: () => import('@/views/new/Admins.vue')
            },
            {
                path: '/user-accounts/new-shop',
                name: 'new-shops',
                component: () => import('@/views/new/NewShops.vue')
            },
            {
                path: '/system/RTP',
                name: 'RTP',
                component: () => import('@/views/new/RTP.vue')
            },
            {
                path: '/system/odds/active-odds',
                name: 'active-odds',
                component: () => import('@/views/new/ActiveOdds.vue')
            },
            {
                path: '/system/odds/shop-odds',
                name: 'shop-odds',
                component: () => import('@/views/new/ShopOdds.vue')
            },
            {
                path: '/jackpot/active-jackpot',
                name: 'active-jackpot',
                component: () => import('@/views/new/ActiveJackpots.vue')
            },
            {
                path: '/jackpot/new-jackpot',
                name: 'new-jackpot',
                component: () => import('@/views/new/NewJackpot.vue')
            },
            {
                path: '/',
                name: 'e-commerce',

...
const submit = async () => {
    ...
    loading.value = true;
    try {
        const tableData = await HTTP.post('cash-reports/regionReport', {
            date: dates.value,
            region: region.value
        });
...
const initFilters1 = () => {
    filters1.value = {
        ...
        region: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.CONTAINS }] },
    ...
    <div class="">
        ...
        <div class="card">
            ...
            <DataTable
                ...
                :loading="loading1"
                :filters="filters1"
                :globalFilterFields="['region', 'bets', 'slipCount', 'payOut', 'unclaimed', 'ggr', 'rtp', 'net']"
                ref="dt"
                showGridlines
            >
                <template #header>

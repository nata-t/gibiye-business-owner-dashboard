...
const submit = async () => {
    ...
    loading.value = true;
    try {
        const tableData = await HTTP.post('cash-reports/masterAgentReport', {
            date: dates.value,
    ...
    <div class="">
        ...
        <div class="card">
            ...
            <DataTable
                ...
                :loading="loading1"
                :filters="filters1"
                :globalFilterFields="['masterAgent', '', 'bets', 'slipCount', 'payOut', 'unclaimed', 'ggr', 'rtp', 'net']"
                ref="dt"
                showGridlines
            >
                <template #header>
